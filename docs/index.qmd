...
```{r}
data |> 
  summarise(VarT = var(temp_wew), VarH = var(rh, na.rm = TRUE), StdT = sd(temp_wew), StdH = sd(rh, na.rm = TRUE))
```
...
*Temperature Distribuion indicating different month of the year*
```{r}
file |> 
