...
Loading useful Library I am employing tidyverse to prove my work and it is also easy to use because it has inbuilt packages like dplyr and ggplot
...
Check for any missing value at the ID/ANIMAL/INDEX i.e the first column if there is missing ID, It has to be handled before analysis
